...
const createStyles = (Colors: ThemeColors) => StyleSheet.create({
  ...
  loginDescription: { fontSize: 13, color: Colors.textMuted, marginTop: 7, marginBottom: 20 },
  ...
  typeBadge: { color: Colors.navySoft, backgroundColor: Colors.surfaceSunken, borderRadius: Radius.control, paddingHorizontal: 9, paddingVertical: 5, fontSize: 12, fontWeight: "900" },
  date: { color: Colors.textFaint, fontSize: 11 },
  reason: { color: Colors.caution, fontSize: 13, fontWeight: "800", marginBottom: 10 },
  title: { color: Colors.text, fontSize: 16, fontWeight: "900" },
  author: { color: Colors.textMuted, fontSize: 12, marginTop: 4 },
  content: { color: Colors.textSub, fontSize: 13, lineHeight: 19, marginTop: 10 },
